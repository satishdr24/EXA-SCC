...
*   Create Workflow Title
    ev_header = |{ TEXT-005 } { /esrcc/cl_wf_utility=>c_title_separator2 } | &&
                |{ ls_stewardship-valid_from DATE = USER } - { ls_stewardship-valid_to DATE = USER } { /esrcc/cl_wf_utility=>c_title_separator2 } | &&
                |{ TEXT-006 } { ls_stewardship-legal_entity } { ls_stewardship-cost_object } { ls_stewardship-cost_center } | &&
                |{ TEXT-007 } { TEXT-008 }|.
  ENDMETHOD.
