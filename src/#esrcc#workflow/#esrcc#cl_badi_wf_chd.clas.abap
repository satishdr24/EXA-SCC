...
*   Create Workflow Title
    ev_header = |{ text-001 }: | &&
                ls_leading_object-hierarchy1 && /esrcc/cl_wf_utility=>c_title_separator &&
                ls_leading_object-hierarchy2 && /esrcc/cl_wf_utility=>c_title_separator &&
                ls_leading_object-hierarchy3 && /esrcc/cl_wf_utility=>c_title_separator &&
                ls_leading_object-hierarchy4 && /esrcc/cl_wf_utility=>c_title_separator &&
