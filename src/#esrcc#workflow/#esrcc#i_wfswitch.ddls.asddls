...
define view entity /ESRCC/I_WfSwitch
  ...
  association [0..1] to /ESRCC/I_WORKFLOWGROUPBY  as _WorkflowgroupbyText on $projection.WorkflowGroupBy = _WorkflowgroupbyText.WorkflowGroupBy
  
{
  key application           as Application,
      workflowactive        as Workflowactive,
      workflowgroupby       as WorkflowGroupBy,
