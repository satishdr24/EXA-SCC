...
CLASS lhc_servicecapacity DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS setuuid FOR DETERMINE ON SAVE
      IMPORTING keys FOR servicecapacity~setuuid.
...
*   Check Authorization
  ...
  METHOD setuuid.
    ...
    MODIFY ENTITIES OF /esrcc/i_servicecapacity IN LOCAL MODE
      ENTITY servicecapacity
    ...
    reported-servicecapacity = CORRESPONDING #( ureported-servicecapacity ).
  ENDMETHOD.
