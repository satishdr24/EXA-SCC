CLASS LHC_/ESRCC/I_RR_OBJCT_S DEFINITION FINAL INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      AUGMENT FOR MODIFY
        IMPORTING
          ENTITIES_CREATE FOR CREATE ObjctAll\_Objct
          ENTITIES_UPDATE FOR UPDATE Objct.
ENDCLASS.

CLASS LHC_/ESRCC/I_RR_OBJCT_S IMPLEMENTATION.
  METHOD AUGMENT.
    DATA: text_for_new_entity      TYPE TABLE FOR CREATE /ESRCC/I_RR_Objct\_ObjctText,
          text_for_existing_entity TYPE TABLE FOR CREATE /ESRCC/I_RR_Objct\_ObjctText,
          text_update              TYPE TABLE FOR UPDATE /ESRCC/I_RR_ObjctText.
    ...
    DATA: text_tky_link  TYPE STRUCTURE FOR READ LINK /ESRCC/I_RR_Objct\_ObjctText,
    ...
    ENDLOOP.
    MODIFY AUGMENTING ENTITIES OF /ESRCC/I_RR_Objct_S
      ENTITY Objct
        CREATE BY \_ObjctText
        FROM text_for_new_entity
        RELATING TO entities_create BY relates_create.

    IF entities_update IS NOT INITIAL.
      READ ENTITIES OF /ESRCC/I_RR_Objct_S
