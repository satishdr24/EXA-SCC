...
//      { type                         : #FOR_ACTION,  dataAction: 'Submit' , label: 'Submit' , position: 2, invocationGrouping: #CHANGE_SET },
      ...
      @Consumption.valueHelpDefinition:[{distinctValues: true },{ entity: { name: '/ESRCC/I_RyearRoyaltyBase', element: 'Ryear' }}]
...
//                                               additionalBinding: [{ element: 'License', localElement: 'license' }]}]
      ...
      @Consumption.valueHelpDefinition:[{ entity: { name: '/ESRCC/I_RoyaltyBaseKeyFF4', element: 'RoyaltyBaseKey' }, useForValidation: true } ]
