...
@EndUserText.label: 'Forecast Line Items'
define root view entity /ESRCC/C_FORECAST_LINEITEMS
  provider contract transactional_query
  as projection on /ESRCC/I_FORECAST_LINEITEMS
{
  ...
  key Costelement,
      ...
      Status,
      @EndUserText.label: 'Posting System-ID'
      posting_sysid,
      @EndUserText.label: 'Posting Company Code'
      posting_ccode,      
      @EndUserText.label: 'Posting Legalentity'
      posting_legalentity,
      @EndUserText.label: 'Posting Cost Object Number'
      posting_costcenter,
      @EndUserText.label: 'Posting Cost Object'
      posting_costobject,      
      WorkflowId,
      CommentId,      
      UniqueId, 
