...
CLASS lhc_rap_tdat_cts DEFINITION.
  PUBLIC SECTION.
    ...
    CLASS-DATA:
        c_tech_id TYPE /esrcc/smbc_technical_id VALUE '/ESRCC/SRVMKP'.
...
CLASS lhc_/esrcc/i_srvmkp IMPLEMENTATION.
  ...
  METHOD triggerworkflow.
    ...
    DATA(lo_wf_handler) = NEW /esrcc/cl_wf_handler_std( application_type = /esrcc/cl_wf_utility=>c_app-bc_product_markup ).
