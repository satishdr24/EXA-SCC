...
*  ENDMETHOD.
  ...
  METHOD updateinternalworkflowstatus.
    ...
    MODIFY ENTITIES OF /esrcc/i_hierdef_s IN LOCAL MODE
        ...
        WITH VALUE #( FOR entity IN entities WHERE ( workflowinternalstatus <> /esrcc/cl_wf_utility=>c_wf_status-draft )
                        ( %tky                      = entity-%tky
                          %is_draft                 = entity-%is_draft
                          workflowinternalstatus    = /esrcc/cl_wf_utility=>c_wf_status-draft
  ...
  METHOD triggerworkflow.
    ...
    DATA(lo_wf_handler) = NEW /esrcc/cl_wf_handler_std( application_type = /esrcc/cl_wf_utility=>c_app-bc_hierarchy_definition ).
  ...
  METHOD schedulejob.
    ...
    DELETE entities WHERE workflowinternalstatus <> /esrcc/cl_wf_utility=>c_wf_status-finalize_in_process.
    IF entities IS INITIAL.
      RETURN.
    ENDIF.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<fs_entity>).
      TRY.
        ...
        CATCH cx_apj_rt INTO DATA(lr_apj_rt).
          ...
          <fs_entity>-workflowstatus = /esrcc/cl_wf_utility=>c_wf_status-finalize_in_error.
          <fs_entity>-workflowstatuscriticality = /esrcc/cl_wf_utility=>wf_status_criticality( status = /esrcc/cl_wf_utility=>c_wf_status-finalize_in_error ).
