  ...
  association [0..1] to /ESRCC/I_LegalEntityAll_F4 as _LegalEntity          on  _LegalEntity.Legalentity = $projection.LegalEntity
{
  key cost_object_uuid      as CostObjectUuid,
      ...
      otp_acc_source        as OTPAccountSource,
      otp_acc_service_cost  as OTPAccServiceCost,
      otp_acc_cstobj_rest   as OTPAccCostobjectRest,
      otp_acc_chout_cstbase as OTPAccChargeoutCostbase,
      otp_acc_chout_markup   as OTPAccChargeoutMarkup,
      otp_acc_trueup         as OTPAccTrueup,
