...

{
  ...
  key TrueupChargeoutRuleId,
      @ObjectModel.text.element: [ 'TruAllocationKeyDescription' ]
  key TruAllocationKey,
  key ReceiverCostObjectUuid,
      ...
      _CostObject._CostObjectText[ Spras = $session.system_language ].Description    as costcenterdescription,
      ...
      _SrvPro._ServiceProductText[ Spras = $session.system_language ].Description    as serviceproductdescription,
      ...
      _RecCostObject._CostObjectText[ Spras = $session.system_language ].Description as receivercostcenterdescription,
