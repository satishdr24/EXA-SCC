  ...
  as select from /esrcc/d_cstobj
{
  key costobjectuuid                as Costobjectuuid,
      ...
      otpaccountsource              as OTPAccountSource,
      otpaccservicecost             as OTPAccServiceCost, 
      otpacccostobjectrest          as OTPAccCostobjectRest,
      otpaccchargeoutcostbase       as OTPAccChargeoutCostbase,
      otpaccchargeoutmarkup         as OTPAccChargeoutMarkup,
      otpacctrueup                  as OTPAccTrueup,
