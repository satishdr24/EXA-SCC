...
*   get all functional areas text
    SELECT * FROM /esrcc/fnc_areat INTO TABLE @DATA(functionalareatexts). "#EC CI_NOWHERE
...
*service types
        ...
        IF sy-subrc <> 0.
          ...
          WITH KEY functional_area = <functionalareas>-functional_area BINARY SEARCH. "#EC CI_SORTED
          IF sy-subrc = 0.
