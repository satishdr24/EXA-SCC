...
*check if trigger is via open task My Inbox
        IF _workflowid IS NOT INITIAL.
          SELECT DISTINCT
              ...
              receivercompanycode,
              receivercostobject,
              receivercostcenter FROM /esrcc/cb_stw AS cbstw
          ...
          LOOP AT cbstw ASSIGNING FIELD-SYMBOL(<cbstw>).
            ...
            APPEND VALUE #( sign = 'I' Option = 'EQ' Low = <cbstw>-receivingentity high = '' )  TO _receivingentity.
            APPEND VALUE #( sign = 'I' Option = 'EQ' Low = <cbstw>-receivercompanycode high = '' )  TO _recccode.
            APPEND VALUE #( sign = 'I' Option = 'EQ' Low = <cbstw>-receivercostobject high = '' )  TO _reccostobject.
            APPEND VALUE #( sign = 'I' Option = 'EQ' Low = <cbstw>-receivercostcenter high = '' )  TO _reccostcenter.
...
*      get group config to check the sign of cost
          ...
          LOOP AT lt_recalculated ASSIGNING FIELD-SYMBOL(<recalculated>).
            ...
            READ TABLE lt_trueups TRANSPORTING NO FIELDS
            ...
            IF sy-subrc = 0.
              CLEAR trueupamount.
              LOOP AT lt_trueups INTO DATA(trueup) FROM sy-tabix.
                IF  trueup-ryear               = <recalculated>-ryear
                AND trueup-poper               = <recalculated>-poper
                AND trueup-sysid               = <recalculated>-sysid
                AND trueup-Legalentity         = <recalculated>-Legalentity
                AND trueup-ccode               = <recalculated>-ccode
                AND trueup-costobject          = <recalculated>-costobject
                AND trueup-costcenter          = <recalculated>-Costcenter
                AND trueup-ServiceProduct      = <recalculated>-ServiceProduct
                AND trueup-ReceiverSysId       = <recalculated>-ReceiverSysId
                AND trueup-ReceiverCompanyCode = <recalculated>-ReceiverCompanyCode
                AND trueup-Receivingentity     = <recalculated>-Receivingentity
                AND trueup-ReceiverCostObject  = <recalculated>-ReceiverCostObject
                AND trueup-ReceiverCostCenter  = <recalculated>-ReceiverCostCenter.
...
*  For the scenario where receivers were changed between standard and re-calculations and receivers not found in recalculation
          LOOP AT lt_standard ASSIGNING <standard>.

            READ TABLE lt_trueups TRANSPORTING NO FIELDS
                                   WITH KEY ryear               = <standard>-ryear
                                            poper               = <standard>-poper
                                            sysid               = <standard>-sysid
                                            Legalentity         = <standard>-Legalentity
                                            ccode               = <standard>-ccode
                                            costobject          = <standard>-costobject
                                            costcenter          = <standard>-Costcenter
                                            ServiceProduct      = <standard>-ServiceProduct
                                            ReceiverSysId       = <standard>-ReceiverSysId
                                            ReceiverCompanyCode = <standard>-ReceiverCompanyCode
                                            Receivingentity     = <standard>-Receivingentity
                                            ReceiverCostObject  = <standard>-ReceiverCostObject
                                            ReceiverCostCenter  = <standard>-ReceiverCostCenter
                                            BINARY SEARCH.

            IF sy-subrc = 0.
              CLEAR trueupamount.
              LOOP AT lt_trueups INTO trueup FROM sy-tabix.
                IF  trueup-ryear               = <standard>-ryear
                AND trueup-poper               = <standard>-poper
                AND trueup-sysid               = <standard>-sysid
                AND trueup-Legalentity         = <standard>-Legalentity
                AND trueup-ccode               = <standard>-ccode
                AND trueup-costobject          = <standard>-costobject
                AND trueup-costcenter          = <standard>-Costcenter
                AND trueup-ServiceProduct      = <standard>-ServiceProduct
                AND trueup-ReceiverSysId       = <standard>-ReceiverSysId
                AND trueup-ReceiverCompanyCode = <standard>-ReceiverCompanyCode
                AND trueup-Receivingentity     = <standard>-Receivingentity
                AND trueup-ReceiverCostObject  = <standard>-ReceiverCostObject
                AND trueup-ReceiverCostCenter  = <standard>-ReceiverCostCenter.
