...
//      Uom,
      ...
      cast(case when _ServiceCost.Chargeout = 'D' then
      ( _ServiceCost.Valueaddcostperunit ) else 0 end as abap.dec(23,2)) as TpValueaddcostperunit,
      
      cast(case when _ServiceCost.Chargeout = 'D' then
      ( ( Valueaddmarkup / 100 ) * _ServiceCost.Valueaddcostperunit ) else 0 end as abap.dec(23,2)) as TpValueaddmarkupCostperunit,

      cast(case when _ServiceCost.Chargeout = 'D' then
      ( _ServiceCost.Passthrucostperunit ) else 0 end as abap.dec(23,2)) as TpPassthruCostperunit,
      
      cast(case when _ServiceCost.Chargeout = 'D' then
      ( (Passthrumarkup / 100 ) * _ServiceCost.Passthrucostperunit ) else 0 end as abap.dec(23,2)) as TpPassthrumarkupCostperunit,
