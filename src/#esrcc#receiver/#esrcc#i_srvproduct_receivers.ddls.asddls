...
define view entity /ESRCC/I_SRVPRODUCT_RECEIVERS
  ...
  and sp_rec.ServiceProductUuid = $projection.ServiceProductUuid
...

{
  ...
  key sp_rec.CostObjectUuid          as ReceiverObjectUUID,      
      ...
      stw_sp.Hierarchy1              as Hierarchy1,
      stw_sp.Hierarchy2              as Hierarchy2,
      stw_sp.Hierarchy3              as Hierarchy3,
      stw_sp.Hierarchy4              as Hierarchy4, 
      stw_sp.BillingFrequency        as BillingFrequency,
      stw_sp.workflow_status         as Status,
