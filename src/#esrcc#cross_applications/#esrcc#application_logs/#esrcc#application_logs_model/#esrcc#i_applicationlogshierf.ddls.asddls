  ...
  association [0..1] to /ESRCC/I_LegalEntityAll_F4     as _LegalEntityText on  _LegalEntityText.Legalentity = $projection.LegalEntity
{
  key cast(hid as sysuuid_c32 preserving type)    as Hid,
      ...
      cast(0 as /esrcc/serial_no)                 as SerialNumber,
      ...
      cast('' as /esrcc/functional_area)          as FunctionalArea,
      ...
      cast('' as /esrcc/rr_object_type   )        as ObjectType,
      cast('' as /esrcc/rr_object_number )        as ObjectNumber,
      cast('' as /esrcc/ledger_de  )              as Ledger,
      cast('' as /esrcc/rr_matter  )              as RRMatter,
      cast('' as /esrcc/rr_related_material    )  as Material,
      cast('' as /esrcc/ref_doc_no )              as ReferenceBelnr,
      cast('' as /esrcc/bschl )                   as PostingKey,
      cast('' as /esrcc/postingdate )             as PostingDate,
      cast('' as /esrcc/rr_object_number_partne ) as PartnerObjectNo,
      cast('' as /esrcc/profit_center_partner )   as PartnerProfitCenter,

      cast( 0 as int4 )                           as LineCount,
...
union all select from /ESRCC/I_AppLogItemsChildHier
{
  key cast(hid as sysuuid_c32 preserving type)        as Hid,
      ...
      _log_items_header._log_header.JobName           as JobName,
      _log_items_header._log_header.JobCount          as JobCount,
...
union all select from /ESRCC/I_InvalidRecordsHier
{
  key cast(hid as sysuuid_c32 preserving type)                as Hid,
      ...
      _log_items_child._log_items_header._log_header.JobName  as JobName,
      _log_items_child._log_items_header._log_header.JobCount as JobCount,
