...
define view entity /ESRCC/I_AppLogItemsChildHier
  ...
  association [1] to /ESRCC/I_InvalidRecordsCount as _invalid_records_count on $projection.hid = _invalid_records_count.parent_hid
...
//      count( * ) as LineCount,
      _invalid_records,
      _log_items_header,
      _invalid_records_count.LineCount as LineCount
}
where
